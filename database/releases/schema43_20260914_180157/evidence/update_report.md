...
**Not published.** This build (`build:43303bc15d28971e37dfd49f`) was decided `blocked`, so it was never swapped into place. `database/paraguay_macro_pilot.duckdb` is still the previously published build (`build:57fe1ff64fb654508b2a8f0a`) and is byte-for-byte unchanged. **The rest of this report describes the blocked build, not the database you have**; it is retained under `database/candidates/` so its `_all` interfaces can be inspected.

Deterministic release: release:549669d609b3dc600b81b9bf
...
- **cda_curve** — `Curva_CDA.xlsx`; vintage `cda_curve:8796a589fc2bd31317efdce7`; publication date `2026-07-31` (content_max_period); status `completed`
...
- **tcn_referential_daily** — `TCN_Referencial_Diario.xlsx`; vintage `tcn_referential_daily:74df666397a33b9c8cdfac10`; publication date `unknown` (pending_content_inference); status `completed`
...
- **cda_curve** — `documented_series`; raw cells: 49813; curated observations: 21854
...
- **tcn_referential_daily** — `documented_series`; raw cells: 12510; curated observations: 7004
...
- **bank_reference / source_total:** 0.16 seconds
- **banking_indicators / reuse_and_validation:** 0.17 seconds
- **banking_indicators / source_total:** 0.17 seconds
- **banks / reuse_and_validation:** 0.31 seconds
- **banks / source_total:** 0.32 seconds
- **bcp_fx_daily / reuse_and_validation:** 0.16 seconds
- **bcp_fx_daily / source_total:** 0.17 seconds
- **cda_curve / ingestion_and_curation:** 121.94 seconds
- **cda_curve / source_discovery_and_metadata:** 1.75 seconds
- **cda_curve / source_total:** 124.25 seconds
- **cda_curve / source_validation:** 0.15 seconds
- **compensatory_fx_sales / reuse_and_validation:** 0.15 seconds
...
- **credit_survey / reuse_and_validation:** 0.15 seconds
- **credit_survey / source_total:** 0.15 seconds
- **direct_investment / reuse_and_validation:** 0.15 seconds
- **direct_investment / source_total:** 0.16 seconds
- **economic_annex / reuse_and_validation:** 0.23 seconds
...
- **exchange_rates / reuse_and_validation:** 0.16 seconds
- **exchange_rates / source_total:** 0.17 seconds
- **financial / reuse_and_validation:** 0.22 seconds
- **financial / source_total:** 0.23 seconds
- **financial_indicators / reuse_and_validation:** 0.18 seconds
- **financial_indicators / source_total:** 0.18 seconds
- **fx_operations / reuse_and_validation:** 0.20 seconds
- **fx_operations / source_total:** 0.21 seconds
- **icc / reuse_and_validation:** 0.14 seconds
- **icc / source_total:** 0.14 seconds
- **insurance_annex / reuse_and_validation:** 0.16 seconds
- **insurance_annex / source_total:** 0.17 seconds
- **interbank_market / reuse_and_validation:** 0.17 seconds
- **interbank_market / source_total:** 0.18 seconds
- **liquidity_facility / reuse_and_validation:** 0.16 seconds
- **liquidity_facility / source_total:** 0.17 seconds
- **lrm_auctions / reuse_and_validation:** 0.17 seconds
- **lrm_auctions / source_total:** 0.18 seconds
- **payments / reuse_and_validation:** 0.18 seconds
- **payments / source_total:** 0.19 seconds
- **securities_trades / reuse_and_validation:** 0.16 seconds
- **securities_trades / source_total:** 0.16 seconds
- **tcn_referential_daily / ingestion_and_curation:** 2.37 seconds
- **tcn_referential_daily / source_discovery_and_metadata:** 0.16 seconds
- **tcn_referential_daily / source_total:** 2.72 seconds
- **tcn_referential_daily / source_validation:** 0.13 seconds
- **NA / concept_mappings:** 0.08 seconds
- **NA / governance_registers:** 0.61 seconds
- **NA / mart_views:** 0.32 seconds
- **NA / observation_missingness:** 17.70 seconds
- **NA / quality_flag_report:** 0.03 seconds
- **NA / quality_screens:** 0.93 seconds
- **NA / reports:** 0.73 seconds
- **NA / series_semantics:** 1.24 seconds
- **NA / source_region_classification:** 0.52 seconds
- **NA / table_reconciliation:** 0.38 seconds
- **NA / table_status_and_domains:** 0.06 seconds
- **NA / validation:** 34.37 seconds

## Expected-grid cost

- **Seconds this attempt:** 17.70 (budget 120)
- Grid rows retained: 267,830 (budget 25,000,000)
- Retained source vintages: 24; vintages contributing a grid: 4
...
- **error / NA / new_vintage_provenance_incomplete:** 2 non-legacy vintage(s) lack mandatory acquisition metadata.
...
- **warning / cda_curve / documented_units_need_review:** 33.33% of observations retain source_units because the workbook does not state a unique unit in the parsed title/header path.
- **warning / cda_curve / documented_hierarchy_unresolved:** 412 parsed sheets contain aggregates/components whose parent-child hierarchy is not fully encoded; do not sum all series blindly.
...
- **warning / tcn_referential_daily / documented_units_need_review:** 100.00% of observations retain source_units because the workbook does not state a unique unit in the parsed title/header path.
- **warning / NA / source_region_unreviewed:** 6,522 published numeric cell(s) across 49 worksheet(s) sit outside every parser region and have no rule in config/source_region_rules.csv saying what they are, so no worksheet they touch can be promoted to validated. See outputs/source_region_review_worklist.csv. Largest: lrm_auctions/Subastas 2024 (  144); banking_indicators/Índice (    7); exchange_rates/USD Fin Mes (1,529); lrm_auctions/Subastas 2015  (  144); lrm_auctions/Subastas 2022 (  144)
...
- **warning / NA / publication_date_inferred_from_content:** 24 source vintage(s) have no official release date in config/source_vintages.csv, so availability is inferred from the filename or the content: bank_reference (pending_content_inference); banking_indicators (filename); banks (filename); bcp_fx_daily (content_max_period); cda_curve (content_max_period); compensatory_fx_sales (content_max_period); corporate_bond_curves (content_max_period); credit_survey (content_max_period); direct_investment (content_max_period); economic_annex (filename); eve (filename); exchange_houses (filename); exchange_rates (filename); financial (filename); financial_indicators (filename); fx_operations (content_max_period); icc (content_max_period); insurance_annex (content_max_period); interbank_market (content_max_period); liquidity_facility (content_max_period); lrm_auctions (content_max_period); payments (filename); securities_trades (content_max_period); tcn_referential_daily (pending_content_inference)
