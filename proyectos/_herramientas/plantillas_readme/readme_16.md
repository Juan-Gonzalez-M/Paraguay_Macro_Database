...
|---|---|---|---|
| `meta_inflacion_manual.csv` | Meta de inflación y rango de tolerancia por fecha de vigencia. **No está en la base**: registro manual con fechas aproximadas; la fila de 2025 está inferida de la EVE | {{RANGO:meta_inflacion_manual.csv}} | Manual, no verificado |
