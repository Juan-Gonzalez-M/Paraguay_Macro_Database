...
|---|---|---|---|
| `panel_carteras_entidad_mes.csv` | Cartera vigente, vencida, **Medida Excepcional COVID (vigente y vencida)**, medidas transitorias, refinanciados, reestructurados, renovados, por moneda | {{RANGO:panel_carteras_entidad_mes.csv}} | Panel provisional |
...
| `panel_ratios_entidad_mes.csv` | 40 ratios publicados (morosidad, RRR/cartera, previsiones, capital) | {{RANGO:panel_ratios_entidad_mes.csv}} | Panel provisional |
| `panel_eeff_riesgo_entidad_mes.csv` | Colocaciones, productos financieros, depósitos, patrimonio y previsiones | {{RANGO:panel_eeff_riesgo_entidad_mes.csv}} | Panel provisional |
